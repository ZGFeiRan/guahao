...
import com.guahao.hancw.action.DataWriter;
import com.guahao.hancw.common.CheckUtil;
import com.guahao.hancw.common.PsiClassUtil;
import com.guahao.hancw.common.StringUtils;
import com.guahao.hancw.common.Utils;
import com.guahao.hancw.config.Config;
import com.guahao.hancw.entity.ClassEntity;
import com.guahao.hancw.entity.DataType;
import com.guahao.hancw.entity.FieldEntity;
import com.guahao.hancw.entity.IterableFieldEntity;
import com.guahao.hancw.ui.FieldsDialog;
...
public class ConvertBridge {
    ...
    private HashMap<String, FieldEntity> declareFields;//属性集合
    private HashMap<String, ClassEntity> declareClass;//内部类
    private String generateClassName;//类名
    ...
    private FieldEntity typeByValue(ClassEntity parentClass, String key, Object type) {
        ...
        if (type instanceof JSONObject) {
            ...
            if (classEntity == null) { //存在引用的内部类，且当前没有生成
