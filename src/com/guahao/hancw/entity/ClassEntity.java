package com.guahao.hancw.entity;

import com.guahao.hancw.ThirdParty.json.JSONObject;
import com.guahao.hancw.ThirdParty.treetable.org.jdesktop.swingx.ux.CellProvider;
import com.guahao.hancw.ThirdParty.treetable.org.jdesktop.swingx.ux.Selector;
...
public class ClassEntity implements Selector, CellProvider {
    ...
    private List<FieldEntity> fields = new ArrayList<>();//属性集合
    private List<ClassEntity> innerClasss = new ArrayList<>();//嵌套类
